...
cmake .. -G "%MSVC_CMAKE_GENERATOR%" -A "%MSVC_CMAKE_ARCH%" -DPSMOVE_BUILD_PYTHON_BINDINGS=OFF -DPSMOVE_USE_PS3EYE_DRIVER=1 -DPSMOVE_BUILD_OPENGL_EXAMPLES=1 -DOpenCV_DIR=./external/opencv/build-%MSVC_PLATFORM%/
IF !ERRORLEVEL! NEQ 0 (
